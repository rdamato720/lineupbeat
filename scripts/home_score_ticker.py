...
<div class="lb-scores-inner"><div class="lb-scores-controls"><div><div class="lb-scores-top"><strong>Scores</strong></div><div class="lb-score-buttons" role="group" aria-label="Scoreboard sport"><button type="button" data-score-sport="nfl" aria-pressed="true">NFL</button><button type="button" data-score-sport="college" aria-pressed="false">College</button></div></div><div class="lb-score-meta"><span id="lb-score-status" role="status">Loading scores…</span><br><a id="lb-score-source" href="https://www.espn.com/nfl/scoreboard" target="_blank" rel="noopener noreferrer">ESPN scores ↗</a></div></div>
...
<noscript>View <a href="https://www.espn.com/nfl/scoreboard">NFL scores</a> or <a href="https://www.espn.com/college-football/scoreboard">college scores</a>.</noscript>
