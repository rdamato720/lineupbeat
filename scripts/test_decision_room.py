...
class DecisionRoomRenderingTests(unittest.TestCase):
    ...
    def test_homepage_routes_and_sport_specific_composition(self):
        ...
        self.assertIn("RECOMMENDATION UNAVAILABLE", home)
        self.assertIn("No reliable call", home)
        self.assertIn("trusted season release does not authorize lineup recommendations", home)
        ...
        self.assertIn("A player call requires an explicitly enabled weekly release", home)
