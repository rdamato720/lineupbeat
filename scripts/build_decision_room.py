...
def home_header() -> str:
    ...
    desktop = "".join((
        ...
        '<a class="vbtn" href="/league-history/">League History</a>',
    ...
    mobile = "".join((
        ...
        '<a class="navlink" href="/league-history/">League History</a>',
