...
<main class="mt-shell mt-dashboard-page"><section class="mt-dashboard-hero"><div class="mt-dashboard-header"><div class="mt-dashboard-copy"><div class="mt-kicker">MY TEAM</div><h1 id="mt-team-name">Loading your team…</h1><p id="mt-league-name">Checking for your saved roster.</p><p class="mt-dashboard-meta" id="mt-league-meta"></p></div><div class="mt-dashboard-actions"><a class="mt-button secondary" href="/my-team/">My Team home</a><button class="mt-button secondary" id="mt-connect" type="button">Retry connection</button><button class="mt-button secondary" id="mt-disconnect" type="button" hidden>Disconnect &amp; clear</button></div></div></section>
...
<section class="mt-dashboard-empty" id="mt-dashboard-empty"><div><small>NO ROSTER FOUND</small><h2>Connect your roster</h2><p>Capture your team with the Fantasy connector, then return here. Your roster stays in this browser.</p><a class="mt-button" href="/my-team/#connect-team">Connect a team</a></div></section></section></main>
{seo.site_footer()}
<script src="/my-team/league-adapter.js"></script><script src="/my-team/espn-adapter.js"></script><script src="/my-team/my-team.js"></script>
</body></html>'''
