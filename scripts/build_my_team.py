...
<main class="mt-shell mt-dashboard-page"><section class="mt-dashboard-hero"><div class="mt-dashboard-header"><div class="mt-dashboard-copy"><div class="mt-kicker">MY TEAM · PRIVATE IN THIS BROWSER</div><h1 id="mt-team-name">Loading your team…</h1><p id="mt-league-name">Checking the Fantasy connector for your saved roster.</p><p class="mt-dashboard-meta" id="mt-league-meta"></p><div class="mt-dashboard-actions"><a class="mt-button secondary" href="/my-team/">My Team home</a><button class="mt-button secondary" id="mt-connect" type="button">Retry connection</button><button class="mt-button secondary" id="mt-disconnect" type="button" hidden>Disconnect &amp; clear</button></div></div><div class="mt-dashboard-visual" aria-hidden="true"><span>LINEUPBEAT · MY TEAM</span><img src="/assets/homepage/team-3d.png" alt=""><strong>ROSTER<br>COMMAND CENTER</strong><small>PROJECTIONS · DECISIONS · DEPTH</small></div></div></section>
...
<section class="mt-team-card mt-dashboard-team" id="mt-team" hidden><div id="mt-outlook"></div><div class="mt-team-block"><div class="mt-team-block-head"><small>Lineup decisions</small><h2>Changes that clear the bar</h2></div><div class="mt-decisions" id="mt-decisions"></div></div><div class="mt-team-block"><div class="mt-team-block-head"><small>Roster intelligence</small><h2>Your complete Week 1 roster</h2></div><div id="mt-roster"></div></div></section>
<section class="mt-dashboard-empty" id="mt-dashboard-empty"><img src="/assets/homepage/team-3d.png" alt=""><div><small>NO CONNECTED ROSTER</small><h2>No team loaded yet.</h2><p>Capture your roster with the Fantasy connector, then return here. Your roster remains in this browser.</p><a class="mt-button" href="/my-team/#connect-team">Connect a team</a></div></section></section></main>
{seo.site_footer()}
<script src="/my-team/league-adapter.js"></script><script src="/my-team/espn-adapter.js"></script><script src="/my-team/my-team.js"></script>
</body></html>'''
