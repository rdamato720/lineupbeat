...
def render_extension_guide() -> str:
    return f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow,noarchive"><title>ESPN extension support | Lineup Beat Development</title><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@400;500;600;700;800&amp;family=Source+Serif+4:opsz,wght@8..60,400;8..60,600;8..60,700&amp;display=swap" rel="stylesheet"><link rel="stylesheet" href="/my-team/my-team.css"></head><body>{seo.site_nav("my_team", "nfl")}<main class="mt-shell"><section class="mt-hero"><div class="mt-kicker">Unlisted beta support</div><h1>Connect ESPN without sharing credentials.</h1><p>Diagnostic version 0.2.2 preserves the local-only ESPN connection while capture remains unresolved. It has no cookie permission, collects no password, token, or manager identity, and is restricted to ESPN Fantasy Football plus the isolated development My Team route.</p><div class="mt-actions"><a class="mt-button" href="/my-team/lineupbeat-espn-extension.zip" download>Download version 0.2.2</a><a class="mt-button secondary" href="/my-team/">Open My Team</a><a class="mt-button secondary" href="/my-team/extension/privacy/">Extension privacy</a></div></section><section class="mt-section"><div class="mt-section-head"><div><small>Use the diagnostic beta</small><h2>Reproduce, copy, review</h2></div></div><div class="mt-proof"><article><h3>1 · Install</h3><p>Unzip the download, open chrome://extensions, enable Developer mode, choose Load unpacked, and select the unzipped folder.</p></article><article><h3>2 · Open ESPN</h3><p>Open the ESPN Fantasy Football team roster that is already visible in your signed-in browser.</p></article><article><h3>3 · Reproduce</h3><p>Select PPR, Half-PPR or Non-PPR and choose Save roster locally for My Team.</p></article><article><h3>4 · Copy diagnostics</h3><p>After the empty-roster error appears, choose Copy safe diagnostics. Nothing is generated or copied before that click, and no diagnostic is sent over the network.</p></article><article><h3>5 · Paste into Codex</h3><p>Paste the copied JSON into Codex for review. It contains structural counts and sanitized URL shapes, not roster or identity content.</p></article><article><h3>6 · Clear</h3><p>If a roster was previously saved, use Disconnect &amp; clear to delete the chrome.storage.local copy.</p></article></div></section><section class="mt-section"><div class="mt-section-head"><div><small>Distribution</small><h2>Development diagnostic package</h2></div><p>This download is byte-identical to the validated eight-file version 0.2.2 development artifact. Live capture remains unresolved, and Chrome Web Store upload and submission remain blocked.</p></div></section></main>{seo.site_footer()}</body></html>'''
