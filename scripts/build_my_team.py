...
def render_extension_guide() -> str:
    return f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow,noarchive"><title>ESPN extension support | Lineup Beat Development</title><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@400;500;600;700;800&amp;family=Source+Serif+4:opsz,wght@8..60,400;8..60,600;8..60,700&amp;display=swap" rel="stylesheet"><link rel="stylesheet" href="/my-team/my-team.css"></head><body>{seo.site_nav("my_team", "nfl")}<main class="mt-shell"><section class="mt-hero"><div class="mt-kicker">Unlisted beta support</div><h1>Connect ESPN without sharing credentials.</h1><p>Version 0.2.6 preserves the proven row-first ESPN roster capture while adding unambiguous visible league/team labels and a local Week 1 roster-intelligence layer. It has no cookie permission, collects no password, token, or manager identity, and remains restricted to ESPN Fantasy Football plus the isolated development My Team route.</p><div class="mt-actions"><a class="mt-button" href="/my-team/lineupbeat-espn-extension.zip" download>Download version 0.2.6</a><a class="mt-button secondary" href="/my-team/">Open My Team</a><a class="mt-button secondary" href="/my-team/extension/privacy/">Extension privacy</a></div></section><section class="mt-section"><div class="mt-section-head"><div><small>Live retest</small><h2>Install, refresh, save</h2></div></div><div class="mt-proof"><article><h3>1 · Install</h3><p>Unzip the download, open chrome://extensions, enable Developer mode, choose Load unpacked, and select the unzipped folder.</p></article><article><h3>2 · Refresh ESPN</h3><p>Open or refresh the ESPN Fantasy Football team roster after version 0.2.6 is loaded.</p></article><article><h3>3 · Save locally</h3><p>Select PPR, Half-PPR or Non-PPR and choose Save roster locally for My Team.</p></article><article><h3>4 · Verify</h3><p>Confirm My Team opens automatically, displays the actual league and team labels, shows no player card titled Q, and surfaces only meaningful eligible lineup changes.</p></article><article><h3>5 · Fallback</h3><p>Return to ESPN and verify Open My Team works. If capture still fails, choose Copy safe diagnostics and paste only that JSON into Codex.</p></article><article><h3>6 · Clear</h3><p>Use Disconnect &amp; clear to delete the chrome.storage.local roster copy.</p></article></div></section><section class="mt-section"><div class="mt-section-head"><div><small>Distribution</small><h2>Development product-polish package</h2></div><p>This download is byte-identical to the validated eight-file version 0.2.6 development artifact. Installed-extension QA and Chrome Web Store upload and submission remain blocked until Ralph's live save passes.</p></div></section></main>{seo.site_footer()}</body></html>'''
