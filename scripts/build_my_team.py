...
<section class="mt-team-card mt-dashboard-team" id="mt-team" hidden><div id="mt-outlook"></div><div class="mt-team-block"><div class="mt-team-block-head"><h2>Lineup decisions</h2></div><div class="mt-decisions" id="mt-decisions"></div></div><div class="mt-team-block"><div class="mt-team-block-head"><h2>Roster</h2></div><div id="mt-roster"></div></div></section>
