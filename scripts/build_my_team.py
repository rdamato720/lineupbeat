...
<meta name="description" content="Connect an ESPN, Yahoo, or CBS fantasy roster locally and compare Week 1 starter and bench projections without uploading roster data.">
...
{nav}
<main class="mt-shell"><section class="mt-hero mt-product-hero"><div class="mt-hero-grid"><div class="mt-hero-copy"><div class="mt-kicker">YOUR FANTASY COMMAND CENTER</div><h1>YOUR ROSTER.<br><span>IN FOCUS.</span></h1><p>Connect ESPN, Yahoo, or CBS. See your strongest projected lineup, the closest comparisons, and the evidence behind each player.</p><div class="mt-actions"><button class="mt-button" id="mt-connect" type="button">Connect Fantasy extension</button><button class="mt-button secondary" id="mt-disconnect" type="button" hidden>Disconnect &amp; clear</button><button class="mt-button secondary" id="mt-demo" type="button" hidden>Load reviewer demo roster</button><a class="mt-button secondary" href="/my-team/extension/">Extension support</a></div><p class="mt-status" id="mt-status" role="status" aria-live="polite">Loading the public Week 1 model…</p></div>
<div class="mt-preview-window"><div class="mt-preview-bar"><span><i></i> FOURTH &amp; LONG</span><b>WEEK 1 · PPR</b></div><div class="mt-preview-body"><small>PROJECTED LINEUP</small><h2>Your roster, in one view.</h2><div class="mt-preview-roster">{example_row(model,'Josh Allen','QB')}{example_row(model,'Bijan Robinson','RB')}{example_row(model,"Ja'Marr Chase",'WR')}{example_row(model,'Brock Bowers','TE')}</div><div class="mt-preview-call"><span><small>CLOSEST COMPARISON</small><strong>{chase['name']} vs. {nacua['name']}</strong></span><b>+{edge:.1f}<small>PT EDGE</small></b></div></div></div></div></section>
<section class="mt-value-section"><div class="mt-section-head"><div><small>WHAT YOU GET</small><h2>Your lineup, explained.</h2></div><p>Not another roster list. My Team puts weekly projections and evidence in one view.</p></div><div class="mt-value-grid"><article><img src="/assets/homepage/rankings-3d.png" alt=""><h3>Projected lineup</h3><p>See which supported players carry the strongest weekly projection.</p></article><article><img src="/assets/homepage/league-3d.png" alt=""><h3>Closest comparisons</h3><p>Focus on players whose projected difference is actually small.</p></article><article><img src="/assets/homepage/team-3d.png" alt=""><h3>Roster outlook</h3><p>Understand your strengths, weak spots, and available depth.</p></article><article><img src="/assets/homepage/college-3d.png" alt=""><h3>Clear evidence</h3><p>See projections, opportunity, matchup context, and honest limits.</p></article></div></section>
<section class="mt-showcase" id="examples"><div class="mt-section-head"><div><small>SEE IT IN ACTION</small><h2>From roster to comparison.</h2></div><p>My Team puts each projection next to the evidence that supports it.</p></div><article class="mt-example"><div class="mt-example-copy"><small>LINEUP COMPARISON</small><h3>See when the edge is real.</h3><p>The higher projection leads. The gap and player context show whether the difference is meaningful or effectively a toss-up.</p><a href="#connect-team">Connect your roster →</a></div><div class="mt-example-window"><div class="mt-example-head"><span>WIDE RECEIVER · CLOSE COMPARISON</span><b>WEEK 1</b></div><div class="mt-example-decision"><div>{example_card(chase,chase_ppr,'HIGHER')}</div><strong>+{edge:.1f}</strong><div>{example_card(nacua,nacua_ppr,'LOWER')}</div></div><div class="mt-example-reason"><span><b>THE EDGE</b>{chase['name']} carries the narrow projection edge.</span><span><b>THE LIMIT</b>This is a close comparison, not a must-make change.</span></div></div></article>
<article class="mt-example reverse"><div class="mt-example-copy"><small>ROSTER OUTLOOK</small><h3>See the whole team—not just one comparison.</h3><p>Scan projected starters, bench depth, position strength, and the closest projection comparisons.</p><a href="#connect-team">Open My Team →</a></div><div class="mt-example-window"><div class="mt-example-head"><span>ROSTER OUTLOOK</span><b>4 STARTERS</b></div><div class="mt-outlook-preview"><div><strong>72.8</strong><small>PROJECTED POINTS</small></div><div><strong>1</strong><small>CLOSE COMPARISON</small></div><div><strong>WR</strong><small>DEEPEST POSITION</small></div></div><div class="mt-mini-roster">{example_row(model,'Josh Allen','QB')}{example_row(model,'Bijan Robinson','RB')}{example_row(model,"Ja'Marr Chase",'WR')}</div></div></article></section>
...
<meta name="description" content="Review your private browser-local fantasy roster, Week 1 outlook, and lineup projection comparisons.">
...
<main class="mt-shell mt-dashboard-page"><section class="mt-dashboard-stage"><div class="mt-dashboard-window"><div class="mt-dashboard-bar"><span><i></i> LINEUPBEAT · MY TEAM</span><b>WEEK 1 · PRIVATE</b></div><header class="mt-dashboard-header"><div class="mt-dashboard-identity"><img src="/assets/homepage/team-3d.png" alt=""><div class="mt-dashboard-copy"><div class="mt-kicker">YOUR TEAM</div><h1 id="mt-team-name">Loading your team…</h1><p id="mt-league-name">Checking for your saved roster.</p><p class="mt-dashboard-meta" id="mt-league-meta"></p></div></div><div class="mt-dashboard-actions"><a class="mt-button secondary" href="/my-team/">My Team home</a><button class="mt-button secondary" id="mt-connect" type="button">Retry connection</button><button class="mt-button secondary" id="mt-disconnect" type="button" hidden>Disconnect &amp; clear</button></div></header>
<section class="mt-dashboard-content"><p class="mt-status" id="mt-status" role="status" aria-live="polite">Loading the public Week 1 model…</p>
<section class="mt-team-card mt-dashboard-team" id="mt-team" hidden><div id="mt-outlook"></div><div class="mt-team-block"><div class="mt-team-block-head"><h2>Lineup comparisons</h2></div><div class="mt-decisions" id="mt-decisions"></div></div><div class="mt-team-block"><div class="mt-team-block-head"><h2>Roster</h2></div><div id="mt-roster"></div></div></section>
<section class="mt-dashboard-empty" id="mt-dashboard-empty"><div><small>NO ROSTER FOUND</small><h2>Connect your roster</h2><p>Capture your team with the Fantasy connector, then return here. Your roster stays in this browser.</p><a class="mt-button" href="/my-team/#connect-team">Connect a team</a></div></section></section></div></section></main>
{seo.site_footer()}
<script src="/my-team/league-adapter.js"></script><script src="/my-team/espn-adapter.js"></script><script src="/my-team/my-team.js"></script>
</body></html>'''
