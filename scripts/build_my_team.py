...
<div class="mt-provider-grid"><article class="mt-provider active"><small>Supported connection</small><h3>ESPN browser-local extension</h3><p>Visible roster capture, local matching, and local Week 1 decisions on Lineup Beat.</p><strong>Connect above</strong></article></div>
</section>
