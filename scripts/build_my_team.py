...
def render_extension_guide() -> str:
    return f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow,noarchive"><title>ESPN extension support | Lineup Beat Development</title><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@400;500;600;700;800&amp;family=Source+Serif+4:opsz,wght@8..60,400;8..60,600;8..60,700&amp;display=swap" rel="stylesheet"><link rel="stylesheet" href="/my-team/my-team.css"></head><body>{seo.site_nav("my_team", "nfl")}<main class="mt-shell"><section class="mt-hero"><div class="mt-kicker">Unlisted beta support</div><h1>Connect ESPN without sharing credentials.</h1><p>The beta extension reads only visible roster rows after an explicit save. It has no cookie permission, collects no password, token, or manager identity, and is restricted to ESPN Fantasy Football plus the isolated development My Team route.</p><div class="mt-actions"><a class="mt-button" href="/my-team/">Open My Team</a><a class="mt-button secondary" href="/my-team/extension/privacy/">Extension privacy</a></div></section><section class="mt-section"><div class="mt-section-head"><div><small>Use the beta</small><h2>Capture, open, clear</h2></div></div><div class="mt-proof"><article><h3>1 · Open ESPN</h3><p>Open the ESPN Fantasy Football team roster that is already visible in your signed-in browser.</p></article><article><h3>2 · Choose scoring</h3><p>Select PPR, Half-PPR or Non-PPR. The extension does not guess league scoring.</p></article><article><h3>3 · Save locally</h3><p>Choose Save roster locally for My Team after reading the in-extension disclosure.</p></article><article><h3>4 · Continue</h3><p>My Team opens automatically. If it does not, choose Open My Team in the extension panel.</p></article><article><h3>5 · Clear</h3><p>Use Disconnect &amp; clear to delete the chrome.storage.local roster copy.</p></article></div></section><section class="mt-section"><div class="mt-section-head"><div><small>Distribution</small><h2>No public package download</h2></div><p>The beta package is distributed only through its authorized Chrome Web Store channel after review. This development website does not publish the ZIP.</p></div></section></main>{seo.site_footer()}</body></html>'''
...
def build(site: Path) -> None:
    ...
    # Store packages are workflow artifacts, not deployed-site assets. Remove
    # the obsolete public download if an incremental build left it behind.
    (target / "lineupbeat-espn-extension.zip").unlink(missing_ok=True)
