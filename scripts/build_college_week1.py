...
def page(position=None):
    ...
    if position is None:
        ...
        document = document.replace(
            '<input id="search" type="search" aria-label="Search players" placeholder="Search players">',
            '<input id="search" type="search" aria-label="Search players" list="college-weekly-player-list" '
