...
APP_CSS, APP_HEADER, APP_FOOTER = site_chrome("data")
...
# Player and team pages are part of Fantasy Data too. Keeping that item
# highlighted gives readers orientation after they follow a deep link.
...
def main():
    ...
    for path, freq, prio in (
            ...
            (f"/{args.sport}/rankings/ppr/", "daily", "0.9"),
            (f"/{args.sport}/rankings/ppr/qb/", "daily", "0.8"),
            (f"/{args.sport}/rankings/ppr/rb/", "daily", "0.8"),
            (f"/{args.sport}/rankings/ppr/wr/", "daily", "0.8"),
            (f"/{args.sport}/rankings/ppr/te/", "daily", "0.8"),
            (f"/{args.sport}/rankings/non-ppr/", "daily", "0.9"),
            (f"/{args.sport}/rankings/non-ppr/qb/", "daily", "0.8"),
            (f"/{args.sport}/rankings/non-ppr/rb/", "daily", "0.8"),
            (f"/{args.sport}/rankings/non-ppr/wr/", "daily", "0.8"),
            (f"/{args.sport}/rankings/non-ppr/te/", "daily", "0.8"),
            (f"/{args.sport}/rankings/top-200-ppr/", "daily", "0.9"),
            (f"/{args.sport}/rankings/top-200-non-ppr/", "daily", "0.9"),
            (f"/{args.sport}/rankings/top-200-superflex/", "daily", "0.9"),
            (f"/{args.sport}/rankings/dynasty/", "daily", "0.9"),
            (f"/{args.sport}/rankings/dynasty/qb/", "daily", "0.8"),
            ...
            ("/college-fantasy-football/week-1/", "daily", "0.9"),
            ("/college-fantasy-football/week-1/results/", "weekly", "0.7"),
            ("/college-fantasy-football/week-1/qb/", "daily", "0.8"),
