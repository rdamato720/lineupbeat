...
def build_page(canonical: dict, summary: dict) -> str:
    ...
    <script>(function(){
      ...
      function providerName(){var provider=state.capture&&state.capture.provider;return provider==='yahoo'?'Yahoo':provider==='cbs'?'CBS':'ESPN';}
