...
const sleeperArchive = {...structuredClone(archive),
  schemaVersion: 'lineupbeat-history-capture-v1', provider: 'sleeper', connectionType: 'public_api'};
assert.doesNotThrow(() => sanitizePublication(sleeperArchive, review));
