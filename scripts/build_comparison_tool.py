...
def main() -> int:
    ...
    hub_html = html(players, built, pairs=pairs).replace(
        ...
        'This advanced comparison adds 2025 weekly floor, ceiling, consistency, and Superflex context to current projections. For weekly projections, use the <a href="/decision-room/nfl/">Week 1 Decision Room</a>.',
        f"This advanced {len(players)}-player mode combines current rankings, projections and ADP with 2025 weekly consistency, floor, ceiling and Superflex context. Use the Week 1 Decision Room for the faster 177-player projection-boundary experience.",
