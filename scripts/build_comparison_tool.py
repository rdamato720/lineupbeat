...
def main() -> int:
    ...
    hub_html = html(players, built, pairs=pairs).replace(
        ...
        "This 218-player advanced mode adds validated 2025 weekly floor, ceiling, consistency, and Superflex context to current projections. For a faster projection-boundary call, use the <a href="/decision-room/nfl/">basic Decision Room</a>.",
        "This advanced 218-player mode combines current rankings, projections and ADP with validated 2025 weekly consistency, floor, ceiling and Superflex context. Use the basic Decision Room for the faster 177-player projection-boundary experience.",
